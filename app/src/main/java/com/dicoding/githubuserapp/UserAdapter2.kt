...
import com.dicoding.githubuserapp.UserDetailActivity.Companion.EXTRA_USER
import de.hdodenhof.circleimageview.CircleImageView

class UserAdapter2 internal constructor(private val context: Context) : RecyclerView.Adapter<UserAdapter2.ViewHolder>() {
   ...
   class ViewHolder internal constructor(val view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val user = users.get(position) as UserItem
